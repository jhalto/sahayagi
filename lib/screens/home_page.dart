...
class _HomePageState extends State<HomePage> {
  ...
  final Stream<QuerySnapshot> _eventStream = FirebaseFirestore.instance.collection('events').orderBy('timestamp', descending: true)
      .snapshots();
  @override
  Widget build(BuildContext context) {
    ...
    children: [
    Text('Posted by: ${data['user_name'] ?? 'Unknown'}', style: appFontStyle(15,)),
    SizedBox(height: 10),
    Text(data['title'] ?? 'Empty', style: appFontStyle(20,)),
    SizedBox(height: 10),
    ...
    SizedBox(height: 10),
    Text('Location:', style: appFontStyle(15,)),
